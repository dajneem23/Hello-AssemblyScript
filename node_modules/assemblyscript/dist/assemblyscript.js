...
`);for(let f=0,m=o.length;f<m;++f){let g=o[f];if(!zr(g,1)){let S=n.getParameterName(f);U(a,this.indentLevel),a.push(S),a.push(" = "),this.makeLiftFromValue(S,g,a),a.push(`;
...
`);let o=a.length;for(let S=Map_keys(r),E=0,T=S.length;E<T;++E){let I=S[E],F=this.ensureModuleId(I),R=r.get(I);if(U(a,this.indentLevel),Pe(I)?a.push(I):(a.push('"'),a.push(ye(I,34)),a.push('"')),!xI(I)){a.push(": __module"),a.push(F.toString()),a.push(`,
...
`)):a.length=o-2;let c=this.importMappings,_=new Array;for(let S=Map_keys(c),E=0,T=S.length;E<T;++E){let I=S[E];if(I=="env")_.push(`  const env = imports.env;
...
`)}if(this.needsLiftString){let S=n.OBJECTInstance,E=S.offsetof("rtSize")-S.nextMemoryOffset,T=1024;a.push(`  function __liftString(pointer) {
    if (!pointer) return null;
    const
...
`)}if(this.needsLiftArray){let S=n.arrayBufferViewInstance.offsetof("dataStart"),E=n.arrayBufferViewInstance.nextMemoryOffset;this.needsGetU32=!0,a.push(`  function __liftArray(liftElement, align, pointer) {
    if (!pointer) return null;
    const
...
`)}if(this.needsLowerArray){let S=n.arrayBufferInstance.id,E=n.arrayBufferViewInstance,T=E.nextMemoryOffset+4,I=E.offsetof("buffer"),F=E.offsetof("dataStart"),R=E.offsetof("byteLength"),C=R+4;this.needsSetU32=!0,a.push(`  function __lowerArray(lowerElement, id, align, values) {
...
`)}if(this.needsLiftTypedArray){let S=n.arrayBufferViewInstance,E=S.offsetof("dataStart"),T=S.offsetof("byteLength");this.needsGetU32=!0,a.push(`  function __liftTypedArray(constructor, pointer) {
    if (!pointer) return null;
...
`)}if(this.needsLowerTypedArray){let S=n.arrayBufferInstance.id,E=n.arrayBufferViewInstance,T=E.nextMemoryOffset,I=E.offsetof("buffer"),F=E.offsetof("dataStart"),R=E.offsetof("byteLength");this.needsSetU32=!0,a.push(`  function __lowerTypedArray(constructor, id, align, values) {
    if (values == null) return 0;
    const
      length = values.length,
      buffer = exports.__pin(exports.__new(length << align, ${S})) >>> 0,
...
`)}if(this.needsLiftStaticArray){let S=n.OBJECTInstance,E=S.offsetof("rtSize")-S.nextMemoryOffset;this.needsGetU32=!0,a.push(`  function __liftStaticArray(liftElement, align, pointer) {
    if (!pointer) return null;
    const
...
`);let S=!1,E=new Array;for(let T=Map_keys(c),I=0,F=T.length;I<F;++I){let R=T[I];if(R=="env")U(a,2),a.push(`env: globalThis,
